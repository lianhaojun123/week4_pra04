...
for i in range(len(almost_numbers)):
    almost_numbers[i] = int(almost_numbers[i])
...
almost_numbers_2 = []
for i in range(len(almost_numbers)):
    if almost_numbers[i] > 9:
        almost_numbers_2.append(almost_numbers[i])
print(almost_numbers_2)
